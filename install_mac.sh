...
echo "  1. Buka Chrome -> chrome://extensions -> Aktifkan Developer Mode"
echo "  2. Klik 'Load unpacked' dan pilih folder 'extension'."
echo "  3. Banner 'started debugging' otomatis disembunyikan permanen!"
echo "================================================================"
echo ""
